...
public class SecurityConfiguration {
	...
	private static final String[] WHITE_LIST = { "/auth/**", "/api-docs/**", "/swagger-ui/**" };
	...
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		...
		http.authorizeHttpRequests(auths -> auths.requestMatchers(WHITE_LIST).permitAll()
				.requestMatchers("/users/**", "/identifications/**")
				.hasAnyAuthority(ERole.USER.name(), ERole.ADMIN.name()).requestMatchers("/addresses/**")
